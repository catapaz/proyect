...
<div id = "wrapper">
  <header>
    ...
    <div class="topnav">  
      ...
      <a class="active" href="https://streetlightdata.000webhostapp.com/project/index">Inicio</a>
    ...
    <div class="contenido">
        <div class="leftpanel">
         <div class="tabla"><!--/* aqui se abre la tabla */-->
                      ...
                      <p>Click izquierdo sobre el marcador para mas información.</p>
                      <p>Click derecho sobre el marcador para eliminar.</p>
       ...
       <div id= "map"></div>
        ...
        <script type="text/javascript">
          ...
          function loadMap()
          {
            ...
            downloadUrl('https://streetlightdata.000webhostapp.com/project/marcadores.php', function(data) {
              ...
              Array.prototype.forEach.call(markers, function(markerElem) {
                ...
                var deleteButton = '<button onclick="myFunction(' + id + ')">Borrar registro</button>';
          ...
          function myFunction(id) {
                ...
                var clickBtnValue = id;
              	var ajaxurl = 'https://streetlightdata.000webhostapp.com/project/delete.php',
